...
double      argOccupiedThresh = 0.65;
double      argFreeThresh     = 0.196;
std::string argMode           = "trinary";
bool        argNegate         = false;
...
void run_mm2grid()
{
    ...
    {
        // Validate mode value
        const std::string modeStr = argMode;
        ...
        doc["negate"]          = argNegate ? 1 : 0;
        doc["occupied_thresh"] = argOccupiedThresh;
        doc["free_thresh"]     = argFreeThresh;
        doc["mode"]            = modeStr;
