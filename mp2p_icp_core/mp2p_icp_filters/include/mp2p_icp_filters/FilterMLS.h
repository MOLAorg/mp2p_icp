 ...
 * If the input cloud has view-direction vectors pointing towards the sensor,
 * ("view_x", "view_y", "view_z") as generated by the default mp2p_icp_filters::Generator,
 * it will be used to disambiguate between the two plane normals so normals point outwards.
 *
