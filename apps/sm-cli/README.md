...
A CLI tool to inspect, visualize, or modify [simple maps](https://docs.mrpt.org/reference/stable/class_mrpt_maps_CSimpleMap.html) `*.simplemap` (from a SLAM mapping session).
